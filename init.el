...
(custom-set-variables
 ...
 '(package-selected-packages
   '(zotxt yaml-mode which-key wgrep vlf use-package undo-tree tuareg rust-mode rmsbolt riscv-mode realgud rainbow-delimiters racket-mode package-lint org-noter merlin magit ivy-xref ivy-bibtex general geiser exec-path-from-shell evil-surround esup eglot disaster cquery counsel-projectile counsel-etags clang-format bison-mode avy auto-virtualenv auctex-latexmk annalist anaconda-mode))
