...
This is a minor mode.  If called interactively, toggle the `Org-Zotxt
...
evaluate the variable `org-zotxt-mode'.
...
`Zotxt-Citekey mode' mode.  If the prefix argument is positive, enable
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `zotxt-citekey-mode'.
